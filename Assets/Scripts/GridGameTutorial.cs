...
public class GridGameTutorial : MonoBehaviour
{
    ...
    public void SetupGridGameTutorial()
    {
        ...
        TutorialStep step3 = new TutorialStep("Then, play by touching the image that makes you feel the most grateful", 3);
        TutorialStep step4 = new TutorialStep("Take a moment after each selection to reflect on what you are grateful for", 4);
        TutorialStep step5 = new TutorialStep("Come back every day to train your brain", 5);
        TutorialStep step6 = new TutorialStep("You can personalize the grid game in the settings by adding your own pictures", 6);
        //TutorialStep step6 = new TutorialStep("You can personalize the grid game in the settings by adding your own pictures", 6);
